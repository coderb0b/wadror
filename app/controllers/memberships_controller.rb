class MembershipsController < ApplicationController
  ...
  def create
    ...
    if not current_user.in? club.members and @membership.save
      ...
      @membership.save
      #redirect_to @membership.user, notice: "You've joined to #{@membership.beerclub}"
  ...
  def destroy    
    @membership.destroy    
    respond_to do |format|
      format.html { redirect_to user_path(@membership.user), notice: "Membership in #{@membership.beerclub} ended" }
